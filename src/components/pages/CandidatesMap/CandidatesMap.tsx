...
import { Search, Filter, List, MapPin, Briefcase, MessageSquare, ArrowLeft, Users, ChevronUp, Home, Eye, ChevronLeft, ChevronRight, X, Award, GraduationCap, Globe } from 'lucide-react';
                                  ...
                                  {user?.role === 'employer' && (
                                    <div className="flex gap-2 mt-2">
                                      <button
                                        ...
                                        className="text-xs text-accent-cyan hover:text-accent-cyan/80 flex items-center gap-1 px-2 py-1 rounded bg-dark-card hover:bg-dark-surface transition-colors"
                                      >
                                      ...
                                      <button
                                        ...
                                        className="text-xs text-accent-cyan hover:text-accent-cyan/80 flex items-center gap-1 px-2 py-1 rounded bg-dark-card hover:bg-dark-surface transition-colors disabled:opacity-50"
                                      >
