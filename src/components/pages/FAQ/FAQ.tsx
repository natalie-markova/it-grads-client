...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Перейдите в раздел "Навыки и Проекты", нажмите "Редактировать" и используйте слайдеры для оценки вашего уровня владения каждым навыком от 0 до 5. Карта автоматически обновится.',
    },
    {
    ...
    },
    {
      ...
      answer: 'В разделе "Навыки и Проекты" найдите секцию "Автоматический анализ проектов", введите ссылку на ваш GitHub репозиторий и нажмите "Анализировать". Система автоматически определит используемые технологии.',
    },
    {
