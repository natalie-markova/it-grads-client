  ...
  const getGraduateSteps = useCallback((): TourStepData[] => [
    {
      ...
      voiceText: 'Привет! Я Парма, твой помощник на платформе Ай-Ти-Грэдс! Давай я покажу тебе, как тут всё устроено.',
      state: 'greeting'
    },
    {
      id: 'profile',
      ...
      voiceText: 'Здесь ты можешь заполнить своё резюме, добавить навыки и опыт. Чем полнее профиль, тем больше шансов найти работу!',
      state: 'pointing',
    ...
    },
    {
      ...
      voiceText: 'Выбери направление и следуй карте развития. Я буду помогать тебе на каждом шагу!',
      state: 'pointing',
      route: '/roadmaps'
    },
    {
      ...
      voiceText: 'Тут можно практиковаться в программировании и соревноваться с другими! Решай задачи и повышай свой рейтинг.',
      state: 'celebration',
      route: '/codebattle'
    },
    {
      ...
      voiceText: 'Готовься к собеседованиям с искусственным интеллектом! Он задаст тебе вопросы и даст обратную связь.',
      state: 'thinking',
    ...
    },
    {
      ...
      voiceText: 'Здесь собраны вакансии от работодателей. Откликайся и находи работу мечты!',
      state: 'pointing',
      route: '/jobs'
    },
    {
      ...
      voiceText: 'Теперь ты знаешь основы! Если что, я всегда рядом. Удачи в поиске работы!',
      state: 'celebration',
      route: '/profile/graduate'
    }
  ], [t]);
  ...
  const getEmployerSteps = useCallback((): TourStepData[] => [
    {
      ...
      voiceText: 'Здравствуйте! Я Парма, помогу вам освоиться на платформе Ай-Ти-Грэдс. Давайте посмотрим основные возможности.',
      state: 'greeting'
    },
    {
      id: 'profile',
      ...
      voiceText: 'Заполните информацию о вашей компании. Это поможет кандидатам узнать вас лучше.',
      state: 'pointing',
    ...
    },
    {
      ...
      voiceText: 'Здесь вы найдёте выпускников с нужными навыками. Используйте фильтры для точного поиска.',
      state: 'pointing',
      route: '/candidates'
    },
    {
      ...
      voiceText: 'Создавайте вакансии и получайте отклики от мотивированных кандидатов.',
      state: 'pointing',
      route: '/profile/employer'
    },
    {
      ...
      voiceText: 'Общайтесь с кандидатами напрямую через встроенный мессенджер.',
      state: 'pointing',
      route: '/messenger'
    },
    {
      ...
      voiceText: 'Теперь вы готовы к работе! Если возникнут вопросы, я всегда рядом. Успехов в поиске талантов!',
      state: 'celebration',
      route: '/profile/employer'
    }
  ], [t]);
